...
A xeometry [Viewer](http://xeolabs.com/xeometry/docs/#viewer) is a single class that wraps the [xeogl](http://xeogl.org) 3D engine in a set of simple data-driven methods that focus on loading glTF models and manipulating scene elements to create cool 3D presentations. Being data-driven, the Viewer is able to track all your changes, and can save and load JSON bookmarks of its runtime state.
